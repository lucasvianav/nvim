...
local v = {
  actions = require("v.packer.plugins.plugins.navigation.telescope.actions"),
  configs = require("v.packer.plugins.plugins.navigation.telescope.configs"),
}
...
v.pickers = require("v.packer.plugins.plugins.navigation.telescope.pickers")
v.searchers = require("v.packer.plugins.plugins.navigation.telescope.searchers")
